...
using Kinoteka.TicketManagement.Domain.Common;
...
namespace Kinoteka.TicketManagement.Persistance
{
    public class KinotekaDbContext : DbContext
    {
        ...
        public KinotekaDbContext(DbContextOptions<KinotekaDbContext> options, ILoggedInUserService loggedInUserService)
         : base(options)
        {
        ...
        {
            modelBuilder.ApplyConfigurationsFromAssembly(typeof(KinotekaDbContext).Assembly);
